<template>
    <div class="w-full">
        <div class="w-[345px] mx-auto">
            ...
            <div class="bg-[#1B1B1B] h-[173px] mt-[16px]">
                <h1 class="text-[20px] text-[#F8DCB5] font-medium text-left  pt-[28px] pl-[22px]">全网NFT个数:<span class="text-[28px]  font-medium ">1000</span>个</h1>
                <div class="w-[304px] mx-auto h-[36px] bg-gradient-to-r from-[#FAE2BE] to-[#E7B67C] rounded-[4px] text-[#633706] mt-[26px] leading-[36px] font-semibold">停止IDO</div>
            </div>
        </div>
    </div>
</template>
